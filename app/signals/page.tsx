      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-xs text-muted">
            {t(
              "2+ soggetti rilevanti acquistano in contanti nella stessa società in 7 giorni · ultimi 90 giorni",
              "2+ insiders making cash purchases at the same company within 7 days · last 90 days",
            )}
          </p>
        </div>
                ...
                <div>
                  ...
                  <p className="mt-0.5 text-xs text-muted">
                    ...
                    {sig.window_start !== sig.window_end
                      ? ` – ${formatDate(sig.window_end, lang)}`
                      : ""}
                    <span className="mx-1 opacity-40">·</span>
                    <span className="font-medium text-signal">
                      {sig.insiders.length}{" "}
                      {t("acquisti", "buys")} · {sig.insiders.length}{" "}
                      {t("insider", "insiders")}
                    </span>
                  </p>
                </div>
